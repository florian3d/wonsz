...
class GameSound:
    ...
    def __init__(self):
        ...
        # io_walk0 = io.BytesIO(open('walk0.wav', 'rb').read())
        # io_walk1 = io.BytesIO(open('walk1.wav', 'rb').read())
        # io_walk2 = io.BytesIO(open('walk2.wav', 'rb').read())
        ...
        # self.snd_walk0 = pygame.mixer.Sound(io_walk0)
        # self.snd_walk1 = pygame.mixer.Sound(io_walk1)
        # self.snd_walk2 = pygame.mixer.Sound(io_walk2)
        ...
        # self.snd_walk0.set_volume(0.25)
        # self.snd_walk1.set_volume(0.25)
        # self.snd_walk2.set_volume(0.25)
